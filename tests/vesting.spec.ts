...
describe('VestingTemplate', () => {
  it('principal', () => {
    ...
    expect(principal0).toEqual(
      Uint8Array.from([
        0, 0, 0, 0, 231, 95, 174, 188, 143, 109, 173, 51, 182, 179, 255, 217,
        224, 124, 45, 90, 169, 170, 31, 211,
      ])
    );
    expect(principal1).toEqual(
      Uint8Array.from([
        0, 0, 0, 0, 88, 148, 144, 14, 42, 122, 93, 94, 166, 72, 155, 132, 184,
        29, 214, 51, 77, 3, 50, 111,
      ])
    );
    expect(principal2).toEqual(
      Uint8Array.from([
        0, 0, 0, 0, 234, 242, 113, 169, 206, 0, 235, 238, 60, 151, 125, 116,
        185, 226, 199, 118, 208, 20, 228, 2,
      ])
    );
  });
  it('self-spawn', () => {
